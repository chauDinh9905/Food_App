...
@JsonKey(name: 'id') int get id;@JsonKey(name: 'name_food') String get nameFood;@JsonKey(name: 'description') String? get description;@JsonKey(name: 'price') int get price;@JsonKey(name: 'image_url') String? get imageUrl;@JsonKey(name: 'available_date') String get availableDate;@JsonKey(name: 'is_ordered') int get isOrdered;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nameFood,description,price,imageUrl,availableDate,isOrdered);

@override
String toString() {
  return 'FoodItemModel(id: $id, nameFood: $nameFood, description: $description, price: $price, imageUrl: $imageUrl, availableDate: $availableDate, isOrdered: $isOrdered)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int id,@JsonKey(name: 'name_food') String nameFood,@JsonKey(name: 'description') String? description,@JsonKey(name: 'price') int price,@JsonKey(name: 'image_url') String? imageUrl,@JsonKey(name: 'available_date') String availableDate,@JsonKey(name: 'is_ordered') int isOrdered
});
...
/// Create a copy of FoodItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nameFood = null,Object? description = freezed,Object? price = null,Object? imageUrl = freezed,Object? availableDate = null,Object? isOrdered = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'name_food')  String nameFood, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'price')  int price, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'available_date')  String availableDate, @JsonKey(name: 'is_ordered')  int isOrdered)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FoodItemModel() when $default != null:
return $default(_that.id,_that.nameFood,_that.description,_that.price,_that.imageUrl,_that.availableDate,_that.isOrdered);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'name_food')  String nameFood, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'price')  int price, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'available_date')  String availableDate, @JsonKey(name: 'is_ordered')  int isOrdered)  $default,) {final _that = this;
switch (_that) {
case _FoodItemModel():
return $default(_that.id,_that.nameFood,_that.description,_that.price,_that.imageUrl,_that.availableDate,_that.isOrdered);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'name_food')  String nameFood, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'price')  int price, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'available_date')  String availableDate, @JsonKey(name: 'is_ordered')  int isOrdered)?  $default,) {final _that = this;
switch (_that) {
case _FoodItemModel() when $default != null:
return $default(_that.id,_that.nameFood,_that.description,_that.price,_that.imageUrl,_that.availableDate,_that.isOrdered);case _:
  return null;
...
class _FoodItemModel implements FoodItemModel {
  const _FoodItemModel({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'name_food') required this.nameFood, @JsonKey(name: 'description') this.description, @JsonKey(name: 'price') required this.price, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(name: 'available_date') required this.availableDate, @JsonKey(name: 'is_ordered') required this.isOrdered});
...
/// Create a copy of FoodItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nameFood = null,Object? description = freezed,Object? price = null,Object? imageUrl = freezed,Object? availableDate = null,Object? isOrdered = null,}) {
