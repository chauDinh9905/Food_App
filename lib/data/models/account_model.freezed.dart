...
@JsonKey(name: 'fullname') String? get fullname;@JsonKey(name: 'staffcode') String? get staffcode;@JsonKey(name: 'accountname') String? get accountname;@JsonKey(name: 'password') String? get password;
...
@override
String toString() {
  return 'AccountModel(fullname: $fullname, staffcode: $staffcode, accountname: $accountname, password: $password)';
}
...
@useResult
$Res call({
@JsonKey(name: 'fullname') String? fullname,@JsonKey(name: 'staffcode') String? staffcode,@JsonKey(name: 'accountname') String? accountname,@JsonKey(name: 'password') String? password
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'fullname')  String? fullname, @JsonKey(name: 'staffcode')  String? staffcode, @JsonKey(name: 'accountname')  String? accountname, @JsonKey(name: 'password')  String? password)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'fullname')  String? fullname, @JsonKey(name: 'staffcode')  String? staffcode, @JsonKey(name: 'accountname')  String? accountname, @JsonKey(name: 'password')  String? password)  $default,) {final _that = this;
switch (_that) {
case _AccountModel():
return $default(_that.fullname,_that.staffcode,_that.accountname,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'fullname')  String? fullname, @JsonKey(name: 'staffcode')  String? staffcode, @JsonKey(name: 'accountname')  String? accountname, @JsonKey(name: 'password')  String? password)?  $default,) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.fullname,_that.staffcode,_that.accountname,_that.password);case _:
  return null;
...
class _AccountModel implements AccountModel {
  const _AccountModel({@JsonKey(name: 'fullname') this.fullname, @JsonKey(name: 'staffcode') this.staffcode, @JsonKey(name: 'accountname') this.accountname, @JsonKey(name: 'password') this.password});
...
@override@JsonKey(name: 'staffcode') final  String? staffcode;
